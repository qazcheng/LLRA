...
def euclid(a, b):
    ...
    #扩展欧几里得算法得到ax+by=gcd(a,b)的整数解
    # proach hence suitable for large numbers
    #非递归方案适合于较大的数字
    x = yy = 0
    y = xx = 1
    while b:
